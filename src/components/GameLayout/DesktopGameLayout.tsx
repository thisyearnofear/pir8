      ...
      <div className="h-screen flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="flex items-center justify-between px-2 sm:px-4 py-1.5 sm:py-2 bg-slate-900/80 border-b border-neon-cyan/30">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className={`px-2 sm:px-3 py-1 rounded-full font-bold text-xs sm:text-sm ${
            ...
            {isMyTurn && (
              <Tooltip content="Speed bonus: <5s = +100 | <10s = +50 | <15s = +25" position="bottom">
                <div className={`text-xs sm:text-sm font-mono cursor-help ${
          ...
          <Tooltip content="Game Menu (M)" position="bottom">
            <button
              ...
              className={`p-3 rounded-lg transition-all min-w-[48px] min-h-[48px] ${
                menuOpen ? 'bg-neon-cyan text-black' : 'bg-slate-700 text-white hover:bg-slate-600'
              }`}
            >
              {menuOpen ? '✕' : '☰'}
            </button>
        ...
        <div className="flex-1 flex items-center justify-center p-4 relative overflow-hidden">
          ...
          {currentPlayer && (
            <div className="absolute top-4 left-4 z-30 flex flex-col gap-3 max-w-xs">
              ...
              <GameEventLog events={gameState.eventLog} maxVisible={4} isCompact={true} />
            </div>
          )}
          ...
          {currentPlayer && (
            <div className="absolute top-4 right-4 z-30">
              <TerritoryBonusPanel player={currentPlayer} gameState={gameState} isCompact={true} />
            </div>
          )}
...
// =============================================================================
// HELPER: Tooltip Component (copied from GameContainer for now)
